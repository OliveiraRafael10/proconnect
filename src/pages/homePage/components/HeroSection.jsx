    ...
    return (
            <section className="bg-[#36759c] py-16 text-center relative overflow-hidden">
                ...
                <div className="flex max-w-5xl mx-auto h-40">
                    <img src={trabalhador} alt="Homem sentado" className="absolute left-0 bottom-0 w-100 md:w-120" />
                    <div className="w-160 h-12 mt-30 flex items-center gap-2 bg-white p-2 rounded shadow mx-auto">
                        <Input />
                        <Button />
                    </div>
